...
email.send_keys("twitter_earn2") #replace with your twitter username
email.send_keys(Keys.ENTER)
time.sleep(3)
password = driver.find_element_by_name("password")
password.send_keys("some_it113@#") #replace with your twitter password
password.send_keys(Keys.ENTER)
time.sleep(6)
driver.get("https://twitter.com/msdhoni?lang=en") #replace with which account you want to do...
